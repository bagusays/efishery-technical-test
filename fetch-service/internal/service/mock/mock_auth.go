...
// Source: github.com/bagusays/efishery-technical-test/internal/service (interfaces: Auth)
...
func (m *MockAuth) ValidateToken(arg0 string) (*model.UserClaim, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateToken", arg0)
	ret0, _ := ret[0].(*model.UserClaim)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
